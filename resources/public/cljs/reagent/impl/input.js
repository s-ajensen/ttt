...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__4544){
var map__4545 = p__4544;
var map__4545__$1 = (((((!((map__4545 == null))))?(((((map__4545.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4545.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4545):map__4545);
var on_write = cljs.core.get.call(null,map__4545__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__4547_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__4547_SHARP_);
}));
